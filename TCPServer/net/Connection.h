...
public:
	...
	int asyncConnect(const std::string& ip, const unsigned int port);
	int asyncConnect(const std::string& ip, const unsigned int port,boost::function<void (boost::shared_ptr<Connection>, const boost::system::error_code&)>& handler);
	int asyncConnect(const std::string& address, const std::string& service);
	int asyncConnect(const std::string& address, const std::string& service,boost::function<void (boost::shared_ptr<Connection>, const boost::system::error_code&)>& handler);
	int start();
	int stop();
